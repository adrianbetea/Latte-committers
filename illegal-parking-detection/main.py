...
UPLOAD_INPUT_CAMERA = os.path.join(base_dir, 'adminResources', 'input', 'car3.mp4')
UPLOAD_OUTPUT_CAMERA = os.path.join(base_dir, 'adminResources', 'output') + os.sep

name = os.path.splitext(os.path.basename(UPLOAD_INPUT_CAMERA))[0]
...
labelsPath = os.path.join(base_dir, 'adminResources', 'models', 'coco.names')
...
# derive the paths to the model weights and model configuration (use repo-relative paths)
weightsPath = os.path.join(base_dir, 'adminResources', 'models', 'yolov4.weights')
configPath = os.path.join(base_dir, 'adminResources', 'models', 'yolov4.cfg')
...
data_list = []
file = os.path.splitext(os.path.basename(inputVideo))[0]
parking_coordinate = os.path.join(base_dir, 'adminResources', 'parking-coordinate')
f = open(os.path.join(parking_coordinate, 'test1.txt'), 'r')
for lines in f:
    lines = eval(lines)
...
# frame dimensions
vs = cv2.VideoCapture(UPLOAD_INPUT_CAMERA)
